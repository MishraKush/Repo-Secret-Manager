...
|repo| A repo to sync the secrets to. Use partial name to sync to repos that contains the string. If empty, secrets will be sync to all repos for the given user/team|No|
